...
class ScanFragment : Fragment()
{
    ...
    {
        return inflater.inflate(R.layout.fragment_scan, container, false) // inflater converts XML to View, container is the parent layout.
    }

    override fun onResume() // when the fragment becomes visible and interactive.
    {
        super.onResume()
        (activity as MainActivity).setTitleText("Scan Item") // cast activity to mainActivity to be able to call the setTitleText Function.
    }
}